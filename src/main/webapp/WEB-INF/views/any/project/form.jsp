...
<acme:form> 
	...
	<acme:input-textarea code="any.project.form.label.abstract" path="$abstract"/>
	...
	<acme:input-checkbox code="any.project.form.label.published" path="published"/>
	<acme:input-textbox code="any.project.form.label.managerUsername" path="manager"/>
</acme:form>